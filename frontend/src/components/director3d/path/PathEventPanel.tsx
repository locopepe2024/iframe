  ...
  return (
    <section className="path-event-panel" aria-labelledby="path-event-title">
      ...
      <div className="path-event-form">
        ...
        <label className="path-export-marker"><span>写入导出标记</span><input type="checkbox" checked={exportMarker} onChange={(event) => setExportMarker(event.target.checked)}/></label>
      </div>
