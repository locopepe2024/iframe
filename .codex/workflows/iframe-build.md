---
name: iframe-build
description: iFrame Studio desktop build workflow for macOS DMG and Windows EXE packaging.
---

# iFrame Studio Desktop Build Workflow

Use this workflow when the user asks to build, package, or prepare a desktop release of iFrame Studio for macOS or Windows.
...
```text
dist_mac/iFrame Studio.app
dist_mac/iFrame Studio.dmg
```
...
- DMG creation failed: `hdiutil detach "/Volumes/iFrame Studio"`
...
```text
dist_windows\iFrame Studio.exe
```
